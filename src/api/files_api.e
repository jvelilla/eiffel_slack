...
feature -- API Access
	...
	files_delete (token: STRING_32; file: STRING_32): detachable STRING_TABLE [ANY]
			-- 
			-- Deletes a file.
			-- 
			-- argument: token Authentication token. Requires scope: &#x60;files:write:user&#x60; (optional, default to null)
			-- 
			-- argument: file ID of file to delete. (optional, default to null)
			-- 
			-- 
			-- Result STRING_TABLE [ANY]
		require
	...
	files_info (token: STRING_32; file: STRING_32; count: STRING_32; page: STRING_32; limit: INTEGER_32; cursor: STRING_32): detachable STRING_TABLE [ANY]
			-- 
			-- Gets information about a file.
			-- 
			-- argument: token Authentication token. Requires scope: &#x60;files:read&#x60; (optional, default to null)
			-- 
			...
			-- 
			-- argument: cursor Parameter for pagination. File comments are paginated for a single file. Set &#x60;cursor&#x60; equal to the &#x60;next_cursor&#x60; attribute returned by the previous request&#39;s &#x60;response_metadata&#x60;. This parameter is optional, but pagination is mandatory: the default value simply fetches the first \&quot;page\&quot; of the collection of comments. See [pagination](/docs/pagination) for more details. (optional, default to null)
			-- 
			-- 
			-- Result STRING_TABLE [ANY]
		require
	...
	files_list (token: STRING_32; user: STRING_32; channel: STRING_32; ts_from: REAL_32; ts_to: REAL_32; types: STRING_32; count: STRING_32; page: STRING_32; show_files_hidden_by_limit: BOOLEAN): detachable STRING_TABLE [ANY]
			-- 
			-- List for a team, in a channel, or from a user with applied filters.
			-- 
			-- argument: token Authentication token. Requires scope: &#x60;files:read&#x60; (optional, default to null)
			-- 
			-- argument: user Filter files created by a single user. (optional, default to null)
			-- 
			...
			-- 
			-- argument: types Filter files by type ([see below](#file_types)). You can pass multiple values in the types argument, like &#x60;types&#x3D;spaces,snippets&#x60;.The default value is &#x60;all&#x60;, which does not filter the list. (optional, default to null)
			-- 
			-- argument: count  (optional, default to null)
			-- 
			-- argument: page  (optional, default to null)
			-- 
			-- argument: show_files_hidden_by_limit Show truncated file info for files hidden due to being too old, and the team who owns the file being over the file limit. (optional, default to null)
			-- 
			-- 
			-- Result STRING_TABLE [ANY]
		require
		...
		do
			...
			l_request.fill_query_params(api_client.parameter_to_tuple("", "count", count));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "page", page));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "show_files_hidden_by_limit", show_files_hidden_by_limit));
	...
	files_revoke_public_ur_l (token: STRING_32; file: STRING_32): detachable STRING_TABLE [ANY]
			-- 
			-- Revokes public/external sharing access for a file
			-- 
			-- argument: token Authentication token. Requires scope: &#x60;files:write:user&#x60; (optional, default to null)
			-- 
			-- argument: file File to revoke (optional, default to null)
			-- 
			-- 
			-- Result STRING_TABLE [ANY]
		require
	...
	files_shared_public_ur_l (token: STRING_32; file: STRING_32): detachable STRING_TABLE [ANY]
			-- 
			-- Enables a file for public/external sharing.
			-- 
			-- argument: token Authentication token. Requires scope: &#x60;files:write:user&#x60; (optional, default to null)
			-- 
			-- argument: file File to share (optional, default to null)
			-- 
			-- 
			-- Result STRING_TABLE [ANY]
		require
	...
	files_upload (token: STRING_32; file: STRING_32; content: STRING_32; filetype: STRING_32; filename: STRING_32; title: STRING_32; initial_comment: STRING_32; channels: STRING_32; thread_ts: REAL_32): detachable STRING_TABLE [ANY]
			-- 
			-- Uploads or creates a file.
			-- 
			-- argument: token Authentication token. Requires scope: &#x60;files:write:user&#x60; (optional, default to null)
			-- 
			-- argument: file File contents via &#x60;multipart/form-data&#x60;. If omitting this parameter, you must submit &#x60;content&#x60;. (optional, default to null)
			-- 
			-- argument: content File contents via a POST variable. If omitting this parameter, you must provide a &#x60;file&#x60;. (optional, default to null)
			-- 
			-- argument: filetype A [file type](/types/file#file_types) identifier. (optional, default to null)
			-- 
			-- argument: filename Filename of file. (optional, default to null)
			-- 
			-- argument: title Title of file. (optional, default to null)
			-- 
			-- argument: initial_comment The message text introducing the file in specified &#x60;channels&#x60;. (optional, default to null)
			-- 
			-- argument: channels Comma-separated list of channel names or IDs where the file will be shared. (optional, default to null)
			-- 
			-- argument: thread_ts Provide another message&#39;s &#x60;ts&#x60; value to upload this file as a reply. Never use a reply&#39;s &#x60;ts&#x60; value; use its parent instead. (optional, default to null)
			-- 
			-- 
			-- Result STRING_TABLE [ANY]
		require
		...
		do
			...
			if attached initial_comment as l_initial_comment then
				l_request.add_form(l_initial_comment,"initial_comment");
			end
			if attached channels as l_channels then
				l_request.add_form(l_channels,"channels");
			end
