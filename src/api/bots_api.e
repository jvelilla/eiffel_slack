...
feature -- API Access
	...
	bots_info (token: STRING_32; bot: STRING_32): detachable STRING_TABLE [ANY]
			-- 
			-- Gets information about a bot user.
			-- 
			-- argument: token Authentication token. Requires scope: &#x60;users:read&#x60; (required)
			-- 
			-- argument: bot Bot user to get info on (optional, default to null)
			-- 
			-- 
		...
		do
			...
			l_request.fill_query_params(api_client.parameter_to_tuple("", "bot", bot));
